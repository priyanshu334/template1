...
export default function HotelComponent() {
  return (
    <div className="flex flex-col md:flex-row items-center gap-8 p-14 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl shadow-lg">
      {/* Images Section */}
      ...
      {/* Text Section */}
      <div className="max-w-lg text-gray-900 space-y-4">
